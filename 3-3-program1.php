...
<head>
    ...
    <link rel="stylesheet" href="css-desanet/3-3-program.css">
...
<body>
  ...
  <div class="program">
    <div class="judul">
    <h1>PROGRAM PEMBERANTASAN SARANG NYAMUK</h1>
    <p>Penulis : Admin</p>
    <p>20 April 2022</p>
    </div>
    <div class="isi">
    <img src="images/program1.jpg" alt="program1">
    <p>Giat Pemberantasan Sarang Nyamuk (PSN) di Lingkungan Desanet akan dilakukan setiap hari sabtu.
      PSN adalah sebuah gerakan pemberantasan sarang nyamuk dengan melakukan 3M Plus.<br>
      3M Plus terdiri dari :<br><br>

      1. Menguras/membersihkan tempat yang sering dijadikan tempat penampungan air seperti bak mandi, ember air, tempat        penampungan air minum, penampung air lemari es dan lain-lain.<br>
      2. Menutup rapat tempat-tempat penampungan air seperti drum, kendi, toren air, dan lain sebagainya.<br>
      3. Memanfaatkan kembali atau mendaur ulang barang bekas yang memiliki potensi untuk jadi tempat perkembangbiakan     nyamuk yang menularkan demam berdarah.<br><br>
      Plus-nya yaitu kegiatan pencegahan DBD lainnya, seperti :<br>
      1. Menaburkan bubuk larvasida (lebih dikenal dengan bubuk abate) pada tempat penampungan air yang sulit dibersihkan<br>
      ...
      7. Menghindari kebiasaan menggantung pakaian di dalam rumah yang bisa menjadi tempat istirahat nyamuk, dan lain- lain.</p>
    </div>
  </div>

    <footer class="text-center text-lg-start bg-dark text-muted" style="margin-top: 10%;">
