...
if (isset($_POST['simpan'])) {
	...
	if (empty($eror)) {
		...
		if ($id != "") {
			$query	 	= "UPDATE pemdas SET deskripsi = '$deskripsi', struktur_img = '$image_name', tgl = now() WHERE id = '$id'";
		} else {
			$query	 	= "INSERT INTO pemdas (deskripsi, struktur_img) VALUES ('$deskripsi', '$image_name')";
		}
		$result 	= mysqli_query(connection(), $query);
